...
public class ProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        final int shadowYOffset = SizeUtils.dp2px( Y_OFFSET);
        final int shadowXOffset = SizeUtils.dp2px( X_OFFSET);
        int mShadowRadius = SizeUtils.dp2px( SHADOW_RADIUS);
     ...
     *
     * @param size One of {@link ProgressDrawable#LARGE} or
     *             {@link ProgressDrawable#DEFAULT}
     */
