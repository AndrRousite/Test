...
import com.letion.green_dao.BuildConfig;
import com.letion.green_dao.R;
import com.letion.green_dao.model.IMessage;
import com.letion.green_dao.view.RoundImageView;
import com.letion.green_dao.view.RoundTextView;
import com.letion.green_dao.view.ShapeImageView;
...
public class PhotoViewHolder<MESSAGE extends IMessage> extends BaseMessageViewHolder<MESSAGE>
    ...
    public void applyStyle(MessageListStyle style) {
        ...
        if (mIsSender) {
            mPhotoIv.setBackgroundDrawable(style.getSendPhotoMsgBg());
            ...
            mPhotoIv.setBackgroundDrawable(style.getReceivePhotoMsgBg());
        }
        ...
        mDisplayNameTv.setPadding(style.getDisplayNamePaddingLeft(), style
                        .getDisplayNamePaddingTop(),
